...
namespace UIPanels
{
    ...
    public class ItemSelector<SelectEventType> where SelectEventType : EventBase<SelectEventType>, new()
    {
        ...
        /// <summary>
        /// Clears all items from the container while also registering it to the selection systtem
        /// </summary>
        public void Clear()
        {
            itemContainer.Clear();
        ...
        /// <summary>
        /// Attempt to select the first element in the list
        /// </summary>
        public void VisuallySelectFirst()
        {
            Reset();
            VisuallySelectNext();
        }
